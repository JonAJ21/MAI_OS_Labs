...
int main() {
    ...
    for (int step = 0; step < steps; ++step) {
        std::cout << "Clasters centers: " << std::endl;
        for (int i = 0; i < k; ++i) {
            std::cout << clasters[i].center.x << ' ' << clasters[i].center.y << ' ' << i << std::endl;
        }
    ...
    //     std::cout << "Claster №: " << claster.center.claster << std::endl;
    //     for (auto point : claster.points) {
